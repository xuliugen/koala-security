...
<div data-role="urlGrantPermissionGrid"></div>
<script>
$(function(){
    ...
    var url = contextPath + '/auth/url/pagingQueryGrantPermissionsByUrlAccessResourceId.koala?urlAccessResourceId=' + urlId;
    $('[data-role="urlGrantPermissionGrid"]').grid({
        identity: 'id',
        columns: columns,
        buttons: buttons(),
        isShowPages: true,
